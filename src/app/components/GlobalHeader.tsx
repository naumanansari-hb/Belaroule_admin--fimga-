...
interface GlobalHeaderProps {
  ...
  onUserRoleChange?: (role: 'super-admin' | 'sub-admin') => void;
}
...
export function GlobalHeader({
  ...
  const searchData = [
    ...
    },
    {
      ...
      category: "User Management",
      icon: User,
      description: "View guest user accounts",
      status: "Active",
      route: "guest-users",
    },
    {
    ...
    },
    {
      ...
      category: "Master Management",
      icon: User,
      description: "Configure body shape options",
      status: "Active",
      route: "body-shape",
    },
    {
      ...
      category: "Master Management",
      icon: Users,
      description: "Manage age group categories",
      status: "Active",
      route: "age-group",
    },
    {
    ...
    },
    {
      ...
      category: "Master Management",
      icon: FileText,
      description: "Manage default wardrobe items",
      status: "Active",
      route: "default-wardrobe",
    },
    {
      id: 10,
      title: "Reward Plans",
      ...
      category: "Master Management",
      icon: Star,
      description: "Configure reward programs",
      status: "Active",
      route: "reward-plans",
    },
    {
    ...
    },
    {
      ...
      category: "Content Moderation",
      icon: UserX,
      description: "Review reported user accounts",
      status: "Pending",
      route: "flagged-users",
    },
    {
      ...
      category: "Content Moderation",
      icon: ClipboardList,
      description: "Review reported wardrobe content",
      status: "Pending",
      route: "flagged-wardrobe-items",
    },
    ...
    },
    {
      ...
      category: "Reports",
      icon: FileText,
      description: "Outfit of the Day statistics",
      status: "Active",
      route: "ootd-report",
    },
    {
      ...
      category: "Reports",
      icon: Star,
      description: "Track reward points activity",
      status: "Active",
      route: "reward-report",
    },
    {
    ...
    },
    {
      ...
      category: "Reports",
      icon: Activity,
      description: "Monitor API usage and token consumption",
      status: "Active",
      route: "api-consumption-report",
    },
    {
      id: 25,
      title: "Bulk Emails",
  ...
  const quickAccessModules = [
    ...
    },
    {
      ...
      name: "Configuration",
      icon: Settings,
      description: "System settings & templates",
      ...
      <div className="h-12 px-6 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 flex-1 max-w-md">
          ...
          <div className="relative flex-1" ref={searchRef}>
            ...
            <input
              type="text"
              placeholder="Search modules, users, reports, settings..."
              value={searchQuery}
              onChange={(e) =>
              ...
              <div className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-lg shadow-xl overflow-hidden">
                ...
                <div className="p-2 border-t border-neutral-200 dark:border-neutral-800">
                  <button 
                    ...
                    className="w-full py-2 text-sm text-primary-600 dark:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-950 rounded transition-colors"
                  >
          ...
          <div className="relative" ref={userRef}>
            ...
            {showUserDropdown && (
              <div className="absolute right-0 top-full mt-2 w-72 bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-lg shadow-xl overflow-hidden">
                ...
                {/* Role Selector */}
                <div className="p-3 border-b border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900">
                    ...
                    <button
                      ...
                      className={`w-full px-3 py-2 text-left text-sm rounded transition-colors flex items-center justify-between ${
                        userRole === 'super-admin'
                          ...
                          : 'text-neutral-700 dark:text-neutral-300 hover:bg-white dark:hover:bg-neutral-950'
                      }`}
                    >
