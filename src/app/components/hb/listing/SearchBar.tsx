...
export function SearchBar({ 
  ...
  return (
    <div className={`relative ${className}`} data-flyout-container>
      <div className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-lg shadow-sm flex-1 max-w-md">
        ...
        <input
          ...
          autoFocus
        />
        {/* Filter button removed - using Show/Hide Filters option instead */}
        {false && (
          <button
