          ...
          {menuItems.map((item, index) => {
            ...
            return (
              <button
                ...
                className="w-full px-3 py-2 text-left text-xs flex items-center gap-2 text-neutral-700 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:text-neutral-900 dark:hover:text-white transition-colors"
              >
